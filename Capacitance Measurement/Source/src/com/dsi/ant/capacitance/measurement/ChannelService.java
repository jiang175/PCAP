...
//import com.dsi.ant.capacitance.measurement.BuildConfig;
import com.dsi.ant.capacitance.measurement.ChannelController.ChannelBroadcastListener;
...
public class ChannelService extends Service {
    ...
    // private byte[] oldInfo = "99999999".getBytes();
    ...
    public class ChannelServiceComm extends Binder {
         ...
         */
        ChannelInfo addNewChannel() throws ChannelNotAvailableException {
    ...
    public ChannelInfo createNewChannel() throws ChannelNotAvailableException {
        ...
        synchronized (mCreateChannel_LOCK) {
            ...
            if (null != antChannel) {
                ...
                channelController = new ChannelController(antChannel,
